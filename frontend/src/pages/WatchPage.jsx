...
const WatchPage = () => {
  ...
  const [currenTrailerIdx, setCurrenTrailerIdx] = useState(0);
  ...
  const handleNext = () => {
    if (currenTrailerIdx < trailers.length - 1) {
      setCurrenTrailerIdx(currenTrailerIdx + 1);
    }
  };

  const handlePrev = () => {
    if (currenTrailerIdx > 0) {
      setCurrenTrailerIdx(currenTrailerIdx - 1);
    }
  };
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <div className="mx-auto container px-4 py-8 h-full">
          ...
          <div className="flex justify-between items-center mb-4">
            <button
              className={`bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${
                currenTrailerIdx === 0 ? "cursor-not-allowed opacity-50" : ""
              }`}
            ...
            <button
              className={`bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${
                currenTrailerIdx === trailers.length - 1
        ...
        {/* Movie details */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-20 maxw6xl mx-auto">
